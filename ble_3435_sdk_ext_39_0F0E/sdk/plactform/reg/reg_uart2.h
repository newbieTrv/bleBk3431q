...
#define UART2_FIFO_STATUS_ADDR   0x00806A08
...
__INLINE uint8_t uart2_tx_fifo_empty_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_FIFO_STATUS_ADDR);
 ...
 * </pre>
 */
#define UART2_ISR_STAT_ADDR   0x00806A14
...
__INLINE uint8_t uart2_rx_fifo_need_rd_isr_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_ISR_STAT_ADDR);
    return ((localVal & ((uint32_t)0x00000002)) >> 1);
}

__INLINE uint8_t uart2_rx_end_isr_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_ISR_STAT_ADDR);
    return ((localVal & ((uint32_t)0x00000040)) >> 6);
}

__INLINE uint8_t uart2_rxd_wakeup_isr_getf(void)
{
    uint32_t localVal = REG_PL_RD(UART2_ISR_STAT_ADDR);
    return ((localVal & ((uint32_t)0x00000080)) >> 7);
}

__INLINE void uart2_isr_stat_set( uint8_t stat)
{ 
	 ASSERT_ERR((((uint32_t)stat << 0) & ~((uint32_t)0x000000FF)) == 0);
   REG_PL_WR(UART2_ISR_STAT_ADDR, (REG_PL_RD(UART2_ISR_STAT_ADDR) & ~((uint32_t)0x000000FF)) | ((uint32_t)stat << 0));
