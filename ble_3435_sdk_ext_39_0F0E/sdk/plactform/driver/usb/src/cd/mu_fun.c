...
//                        pPort->wSetupDataSize = ulgHidReportDescriptorLen;
                        ...
                        {
                        	case 0:
                        	MUSB_MemCopy(pPort->pSetupData, gHidISOCVoiceReportDescriptor, ulgHidISOCVoiceReportDescriptorLen);
...
//        os_printf("CLASS\r\n");
        ...
        os_printf("CLASS: pRequest->bRequest = 0x%x, wIndex = 0x%x, wValue = 0x%x\r\n",
